...
const getCountries= async() =>{
  ...
  console.log("this is after the setMApcountries" , mapCountries)
  });   
};
//const countries=[{name:'Afghanistan',value:'AG'},{name:'Al'}]
getCountries();
...
const onCountryChange= async (event) => {
 ...
 // console.log("here is the: " , CountryCode);
 ...
 // setCountry(CountryCode);  
  ...
  //  console.log("this is the dataaaa", data)
    setCountryInfo(data) 
    //console.log("HERE IS THE LOCCCCC" ,data.countryInfo.lat,)
